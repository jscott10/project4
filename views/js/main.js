...
// Changes the value for the size of the pizza above the slider
	...
	var totalDxRunningTime = 0;

	// Returns the size difference to change a pizza element from one size to another. Called by changePizzaSlices(size).
//	function determineDx (elem, size) {
	function determineDx (windowwidth, elemOffsetWidth, size) {
//		window.performance.mark("determineDx_start");	// Dx start
...
//		var windowwidth = document.querySelector("#randomPizzas").offsetWidth;
		...
		// time to run Dx
//		window.performance.mark("determineDx_end");	// Dx End
		return dx;
	}
...
/*	function changePizzaSizes(size) {
		// Store the array of randomPizzaContainers
		var randomPizzaContainers = document.querySelectorAll(".randomPizzaContainer");	// NEW
		// Store the offsetWidth of the randomPizzas div
		var windowwidth = document.querySelector("#randomPizzas").offsetWidth;
		// Store the offsetWidth of the FIRST randomPizzaContainer (they're all the same width)
		var elemOffsetWidth = randomPizzaContainers[0].offsetWidth;
//		for (var i = 0; i < document.querySelectorAll(".randomPizzaContainer").length; i++) { // Adds ~2ms
		for (var i = 0; i < randomPizzaContainers.length; i++) {
//			var dx = determineDx(document.querySelectorAll(".randomPizzaContainer")[i], size);
			var dx = determineDx(windowwidth, elemOffsetWidth, size); // NEW
//			window.performance.measure("measure_determineDX", "determineDx_start", "determineDx_end");
//			var dxRunningTime = window.performance.getEntriesByName("measure_determineDX");
//			totalDxRunningTime += dxRunningTime[0].duration;
//			var newwidth = (document.querySelectorAll(".randomPizzaContainer")[i].offsetWidth + dx) + 'px';
			var newwidth = (elemOffsetWidth + dx) + 'px'; // NEW
//			document.querySelectorAll(".randomPizzaContainer")[i].style.width = newwidth; // Adds ~2ms
			randomPizzaContainers[i].style.width = newwidth; // NEW
		}
//		console.log("Total Time in Dx: " + totalDxRunningTime + "ms");
	}
*/
	// Iterates through pizza elements on the page and changes their widths
	// This one calls document.querySelectorAll(".randomPizzaContainer")
	// <~5ms
	function changePizzaSizes(size) {
		// Store the array of randomPizzaContainers
		var randomPizzaContainers = document.querySelectorAll(".randomPizzaContainer");	// NEW
...
//	window.performance.mark("mark_start_changePizzaSizes");   // Entering changePizzaSizes
	changePizzaSizes(size);
//	window.performance.mark("mark_end_changePizzaSizes");   // start the timer
//	window.performance.measure("measure_changePizzaSizes", "mark_start_changePizzaSizes", "mark_end_changePizzaSizes");
//	var changePizzaSizesTime = window.performance.getEntriesByName("measure_changePizzaSizes");
//	console.log("Time in changePizzaSizes: " + changePizzaSizesTime[0].duration + "ms");
